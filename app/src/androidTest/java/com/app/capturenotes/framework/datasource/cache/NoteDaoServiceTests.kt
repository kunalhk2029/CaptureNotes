package com.app.capturenotes.framework.datasource.cache
...
class NoteDaoServiceTests: BaseTest(){
    ...
    fun deleteNoteList_confirmDeleted() = runBlocking {
        val noteList: ArrayList<Note> = ArrayList(noteDaoService.getAllNotes())
        ...
        val searchResults = noteDaoService.getAllNotes()
    ...
    fun searchNotes_orderByTitleASC_confirmOrder() = runBlocking {
        ...
        for(index in 1 until noteList.size - 1){
